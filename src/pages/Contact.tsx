    ...
    <div className="py-12 bg-dark">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-2">
          ...
          <div className="bg-dark-light p-6 rounded-lg shadow-lg border border-dark-lighter">
            ...
            <div className="mt-8">
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://enguerand-ca.fr" className="text-gray-400 hover:text-primary transition-colors">
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div className="bg-dark-light p-6 rounded-lg shadow-lg border border-dark-lighter">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <button
                  type="submit"
                  className="w-full flex justify-center items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-primary hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary"
                >
